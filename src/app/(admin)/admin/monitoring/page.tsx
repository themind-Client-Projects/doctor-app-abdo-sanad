...
export default function MonitoringPage() {
  ...
  const metrics = [
    ...
    { label: "آخر نسخة احتياطية", value: data?.lastBackup ? formatDateTime(data.lastBackup) : "—", icon: <Database size={22} />, color: "border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-950/20", iconColor: "text-amber-600 dark:text-amber-400" },
