...
export default function AdminDashboardPage() {
  ...
  const kpis = [
    ...
    { label: "إجمالي الإيرادات", value: formatCurrency(data?.totalRevenue ?? 0), icon: <DollarSign size={22} />, color: "bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400", border: "border-amber-200 dark:border-amber-800" },
    { label: "صافي أرباح وريد", value: formatCurrency(data?.waridProfit ?? 0), icon: <TrendingUp size={22} />, color: "bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400", border: "border-purple-200 dark:border-purple-800" },
