...
export function TopNavbar() {
  ...
  return (
    <div className="fixed top-0  left-0 right-0 z-50 bg-white/95 backdrop-blur-md" style={{ paddingTop: 'env(safe-area-inset-top, 0px)' }}>
      <header className="max-w-md mx-auto px-5 pt-6 pb-4 flex items-center justify-between">
        ...
        <Link href="/wallet" className="flex items-center gap-1.5 bg-[#eaf6ef] text-[#10b981] px-3 py-1.5 rounded-full transition-transform active:scale-95 shadow-sm border border-[#10b981]/20">
